...
class WebSocketTransport(QWebChannelAbstractTransport):
    ...
    def download(self, msg):
        filename, ok2 = QFileDialog.getSaveFileName(dialog, "Export Excel", "C:/用户数据.xlsx", 'Excel File (*.xlsx)');
        log.info(filename);
        data={};
        data["type"] = 10;
        data["path"]=filename;
...
if __name__ == "__main__":
    ...
    app.setApplicationDisplayName("MyLike P2 Client V1.1")
