...
"C:\Program Files (x86)\WinRAR\WinRAR.exe" a -ep1 D:\mydocument\myprojects\python\mylike\pyqt5\dist\mylike-p2_v2.3.2.rar ./dist\standalone
echo press file mylike-p2_v2.3.2.rar
pause